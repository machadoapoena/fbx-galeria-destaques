...
export default function App() {
  ...
  if (tournamentPlayers.length === 0) {
    return (
      <div className="min-h-screen bg-zinc-50 text-zinc-900 flex items-center justify-center p-4 selection:bg-amber-500 selection:text-white relative overflow-hidden">
        ...
        <div className="relative max-w-md w-full bg-white rounded-3xl border border-zinc-200/80 p-8 text-center space-y-6 z-10 shadow-2xl animate-fade-in">
          <div className="h-16 w-16 rounded-full bg-zinc-50 flex items-center justify-center mx-auto border border-amber-500/20 shadow-sm">
            <Search className="w-6 h-6 text-amber-500" />
          </div>
          <div className="space-y-2">
            <h1 className="text-xl font-bold tracking-tight text-zinc-900">Torneio não Identificado</h1>
            <p className="text-xs text-zinc-500 leading-relaxed">
              Não encontramos nenhum enxadrista associado ao identificador <code className="bg-zinc-100 px-1.5 py-0.5 rounded text-amber-600 font-mono">"{rawTournamentId}"</code>.
            </p>
          </div>
          <div className="p-4 bg-zinc-50 rounded-2xl border border-zinc-150 text-left space-y-3">
            <p className="text-[10px] font-bold text-amber-600 uppercase tracking-widest">Torneios Disponíveis:</p>
            <div className="space-y-2">
              <a 
                href="?tournament=fbx-cbc-2025" 
                className="flex items-center justify-between p-2.5 bg-white hover:bg-zinc-50 border border-zinc-200 hover:border-amber-500/35 rounded-xl text-xs font-semibold text-zinc-700 transition-all hover:text-amber-600 group"
              >
                <span>Campeonato Brasiliense Absoluto 2025</span>
                <span className="text-[9px] bg-zinc-100 px-2 py-0.5 rounded text-amber-600 font-mono group-hover:text-amber-500">fbx-cbc-2025</span>
              </a>
              <a 
              ...
              >
                ...
                <span className="text-[9px] bg-zinc-100 px-2 py-0.5 rounded text-amber-600 font-mono group-hover:text-amber-500">aberto-curitiba</span>
              </a>
            </div>
          </div>
          <p className="text-[10px] text-zinc-400 leading-relaxed">
            Certifique-se de passar o identificador correto como parâmetro na URL (ex: <span className="font-mono text-amber-500">?tournament=nome-do-torneio</span>).
          </p>
        </div>
      </div>
    );

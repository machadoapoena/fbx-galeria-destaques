...
export const PLAYERS: Player[] = [
  ...
  {
    id: '4',
    name: 'Rafael Mazzochin Machado',
    photo: 'https://fbx.org.br/wp-content/uploads/2026/07/fdsfdsCapture-9.jpg',
    ...
    cbxId: '82235',
    fideId: '44760922',
    trajectory: 'No começo foi participando dos torneios do FIX logo após a pandemia. Depois começei a participar nos torneios maiores. E posteriormente em torneios nacionais como FENAC, Brasileiro Escolar e o Brasília Chess Open.',
    discovery: 'Descobri o xadrez na escola La Salle aos 5 anos. Fazia parte da grade escolar.',
    idol: 'Magnus Carlsen, o "Mago de Riga". Adoro o seu lema de que o xadrez é, antes de tudo, uma arte de imaginação e emoção.',
    goals: 'Primeiro passo o título de Mestre Nacional e depois as outras titulações .',
    achievements: [
      'Campeão Brasiliense 2025 (SUB12)',
      '9o Lugar Campeonato Brasileiro Escolar 2024'
    ],
    tournamentId: 'fbx-cbc-2025',
    supporters: [
